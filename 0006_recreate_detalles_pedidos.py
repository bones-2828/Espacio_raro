	...
	operations = [
		migrations.CreateModel(
			...
			fields=[
				...
				('pedido', models.ForeignKey(to='main.Pedidos', on_delete=models.CASCADE, related_name='detalles')),
				('producto', models.ForeignKey(to='main.Producto', on_delete=models.CASCADE)),
			],
		),
	]
